...
namespace gtpsa::python {
  ...
  protected:
    using capsule_ptr =
      std::shared_ptr<gtpsa::python::StateSpaceWithNamedIndex<T>>;
  private:
  ...
  /**
   * @brief allows accessing a tpsa object which is part of the state space
   *        vector
   *
   * handled as part of gtpsa as it needs to export the same functionality as a
   * gtpsa object
   */
  template<class T, typename = typename T::tpsa_type,
	   typename = typename T::base_type>
  class ss_vect_element_access : public
  ss_vect_list_access<typename T::tpsa_type> {
  ...
  public:
	...
	(this->getTpsaObjectIntern(), this->getVectorPtr()->getMapping());
    }
    ...
    (std::shared_ptr<gtpsa::python::IndexMapping> mapping) const {
      this->getVectorPtr()->setMapping(mapping);
    }

    auto uid             ( int32_t uid )
    { return this->getTpsaObjectIntern().uid(uid)         ; }
    auto setName         ( std::string s)
    { return this->getTpsaObjectIntern().setName(s)       ; }
    auto clear           ( void )
    { return this->getTpsaObjectIntern().clear()          ; }
    auto name            ( void ) const
    { return this->getTpsaObjectIntern().name()           ; }
    auto order           ( void ) const
    { return this->getTpsaObjectIntern().order ()         ; }
    auto length          ( void ) const
    { return this->getTpsaObjectIntern().length()         ; }
    auto getDescription  ( void ) const
    { return this->getTpsaObjectIntern().getDescription() ; }
    auto isNull          ( void ) const
    { return this->getTpsaObjectIntern().isNull()         ; }
    auto pstr            ( void ) const
    { return this->getTpsaObjectIntern().pstr()           ; }
    auto repr            ( void ) const
    { return this->getTpsaObjectIntern().repr()           ; }
    auto getCoefficients ( void ) const
    { return this->getTpsaObjectIntern().getCoefficients(); }


    auto newFromThis     ( void ) const
    { return this->getTpsaObject().newFromThis()          ; }
    auto clone           ( void ) const
    { return this->getTpsaObject().clone      ()          ; }
    auto cst             ( void ) const
    { return this->getTpsaObject().cst()                  ; }

    auto get ( void )                        const
    { return this->getTpsaObjectIntern().get()   ; }
    auto get ( const idx_t i )               const
    { return this->getTpsaObjectIntern().get(i)   ; }
    auto get ( const std::vector<ord_t>& m ) const
    { return this->getTpsaObjectIntern().get(m)  ; }
    ...
    inline void getv(idx_t i, std::vector<typename T::base_type> *v) const
    { this->getTpsaObjectIntern().getv(i, v); }
    inline void setv(idx_t i, const std::vector<typename T::base_type> &v)
    { this->getTpsaObjectIntern().setv(i, v); }

    inline auto getsm(const std::vector<int>& m) const
    { return this->getTpsaObjectIntern().getsm(m); }

    void setVariable
    (const typename T::base_type v, const idx_t iv= 0,
     const typename T::base_type scale = 0) {
      this->getTpsaObjectIntern().setVariable(v, iv, scale);
    }
    inline auto index(std::string s) const
    { return this->getTpsaObjectIntern().index(s)        ; }
    inline auto index(const std::vector<ord_t>& m) const
    { return this->getTpsaObjectIntern().index(m)        ; }
    ...
    // auto& operator -
    // (void) const { auto n = this->clone();
    //   return operator- (this->getTpsaObject()); }
    // auto& operator - (void) const
    // { return operator- (this->getTpsaObject()); }

    auto& operator += (const base_type  o )
    { this->getTpsaObjectIntern() += o; return *this; }
    auto& operator -= (const base_type  o )
    { this->getTpsaObjectIntern() -= o; return *this; }
    auto& operator *= (const base_type  o )
    { this->getTpsaObjectIntern() *= o; return *this; }
    ...
    auto& operator += (const tpsa_type& o )
    { this->getTpsaObjectIntern() += o;  return *this; }
    auto& operator -= (const tpsa_type& o )
    { this->getTpsaObjectIntern() -= o;  return *this; }
    auto& operator *= (const tpsa_type& o )
    ...
    auto  operator +  (const tpsa_type  o ) const
    { return this->getTpsaObject().operator+(o); }
    auto  operator -  (const tpsa_type  o ) const
    { return this->getTpsaObject().operator-(o); }
    auto  operator *  (const tpsa_type  o ) const
    { return this->getTpsaObject().operator*(o); }
    ...
    auto  radd  (const base_type o ) const
    { return  o  + this->getTpsaObject(); }
    auto  rsub  (const base_type o ) const
    { return  o  - this->getTpsaObject(); }
    auto  rmul  (const base_type o ) const
    { return  o  * this->getTpsaObject(); }
    auto  rdiv  (const base_type o ) const
    { return  o  / this->getTpsaObject(); }

    auto  radd  (const tpsa_type o ) const
    { return  o  + this->getTpsaObject(); }
    auto  rsub  (const tpsa_type o ) const
    { return  o  - this->getTpsaObject(); }
    auto  rmul  (const tpsa_type o ) const
    { return  o  * this->getTpsaObject(); }
    auto  rdiv  (const tpsa_type o ) const
    { return  o  / this->getTpsaObject(); }

    tpsa_type pow(const int n) const
    { return gtpsa::pow(this->getTpsaObject(), n); }
    ...
    */
    ...
    (gtpsa::tpsa * o, void(f)(const tpsa_type& a, tpsa_type* r)) const {
    ...
    inline void rapply_ss_vect_access
    (const ss_vect_element_access<T>& o, void(f)
     (const tpsa_type& a, tpsa_type* r)) {
  ...
  typedef ss_vect_element_access<gtpsa::TpsaTypeInfo>
  ...
  template<class C>
  auto operator+
  (const typename C::tpsa_type& a,
   const gtpsa::python::ss_vect_element_access<C>& b)
  { return b.radd(a); }
  template<class C>
  auto operator-
  (const typename C::tpsa_type& a,
  ...
  template<class C>
  auto  operator +
  (const ss_vect_element_access<C>& a, const gtpsa::tpsa& b )
  { return a.getTpsaObject() +  b; }
  template<class C>
  auto  operator -
  (const ss_vect_element_access<C>& a, const gtpsa::tpsa& b )
  { return a.getTpsaObject() -  b; }
  ...
  template<class C>
  auto  operator +
  (const ss_vect_element_access<C>& a, const ss_vect_element_access<C>& b )
  { return a.getTpsaObject() + b.getTpsaObject(); }
  template<class C>
  auto  operator -
  (const ss_vect_element_access<C>& a, const ss_vect_element_access<C>& b )
  { return a.getTpsaObject() - b.getTpsaObject(); }
  ...
  template<class C>
  auto operator+
  (const typename C::base_type a, const ss_vect_element_access<C>& b)
  {return b.radd(a); }
  template<class C>
  auto operator-
  (const typename C::base_type a, const ss_vect_element_access<C>& b)
