...
namespace gtpsa {
  ...
  template<class C, typename =
	   typename C::base_type, typename = typename C::tpsa_type,
	   typename = typename C::variant_type>
  class GTpsaOrBase;
  ...
  public:
    ...
    inline GTpsaOrBase& operator+= (const base_type    b)
    { add_helper(this->m_arg, b, &this->m_arg); return *this; }
    inline GTpsaOrBase& operator-= (const base_type    b)
    { sub_helper(this->m_arg, b, &this->m_arg); return *this; }
    inline GTpsaOrBase& operator*= (const base_type    b)
    { mul_helper(this->m_arg, b, &this->m_arg); return *this; }
    inline GTpsaOrBase& operator/= (const base_type    b)
    { div_helper(this->m_arg, b, &this->m_arg); return *this; }

    inline GTpsaOrBase& operator+= (const GTpsaOrBase& b)
    { add_helper(this->m_arg, b.m_arg, &this->m_arg); return *this; }
    inline GTpsaOrBase& operator-= (const GTpsaOrBase& b)
    { sub_helper(this->m_arg, b.m_arg, &this->m_arg); return *this; }
    inline GTpsaOrBase& operator*= (const GTpsaOrBase& b)
    { mul_helper(this->m_arg, b.m_arg, &this->m_arg); return *this; }
    inline GTpsaOrBase& operator/= (const GTpsaOrBase& b)
    { div_helper(this->m_arg, b.m_arg, &this->m_arg); return *this; }

    inline GTpsaOrBase  operator-  (void)                 const
    { GTpsaOrBase n = *this; neg_helper(this->m_arg,    &n.m_arg); return n; }
    inline GTpsaOrBase  operator+  (const base_type    b) const
    { GTpsaOrBase n = *this; add_helper(this->m_arg, b, &n.m_arg); return n; }
    inline GTpsaOrBase  operator-  (const base_type    b) const
    { GTpsaOrBase n = *this; sub_helper(this->m_arg, b, &n.m_arg); return n; }
    inline GTpsaOrBase  operator*  (const base_type    b) const
    { GTpsaOrBase n = *this; mul_helper(this->m_arg, b, &n.m_arg); return n; }
    inline GTpsaOrBase  operator/  (const base_type    b) const
    { GTpsaOrBase n = *this; div_helper(this->m_arg, b, &n.m_arg); return n; }

    inline GTpsaOrBase  operator+  (const tpsa_type    b) const
    { GTpsaOrBase n = *this; add_helper(this->m_arg, b, &n.m_arg); return n; }
    inline GTpsaOrBase  operator-  (const tpsa_type    b) const
    { GTpsaOrBase n = *this; sub_helper(this->m_arg, b, &n.m_arg); return n; }
    inline GTpsaOrBase  operator*  (const tpsa_type    b) const
    ...
    inline GTpsaOrBase  operator+  (const GTpsaOrBase& b) const
    { GTpsaOrBase n = *this; add_helper(this->m_arg, b.m_arg, &n.m_arg);
      return n; }
    inline GTpsaOrBase  operator-  (const GTpsaOrBase& b) const
    { GTpsaOrBase n = *this; sub_helper(this->m_arg, b.m_arg, &n.m_arg);
      return n; }
    inline GTpsaOrBase  operator*  (const GTpsaOrBase& b) const
    { GTpsaOrBase n = *this; mul_helper(this->m_arg, b.m_arg, &n.m_arg);
      return n; }
    inline GTpsaOrBase  operator/  (const GTpsaOrBase& b) const
    { GTpsaOrBase n = *this; div_helper(this->m_arg, b.m_arg, &n.m_arg);
      return n; }

    inline GTpsaOrBase  dadd       (const base_type    a) const
    { GTpsaOrBase n = *this; add_helper(a, this->m_arg, &n.m_arg); return n; }
    inline GTpsaOrBase  dsub       (const base_type    a) const
    { GTpsaOrBase n = *this; sub_helper(a, this->m_arg, &n.m_arg); return n; }
    inline GTpsaOrBase  dmul       (const base_type    a) const
    { GTpsaOrBase n = *this; mul_helper(a, this->m_arg, &n.m_arg); return n; }
    inline GTpsaOrBase  ddiv       (const base_type    a) const
    { GTpsaOrBase n = *this; div_helper(a, this->m_arg, &n.m_arg); return n; }

    inline GTpsaOrBase  dadd       (const tpsa_type    a) const
    { GTpsaOrBase n = *this; add_helper(a, this->m_arg, &n.m_arg); return n; }
    inline GTpsaOrBase  dsub       (const tpsa_type    a) const
    { GTpsaOrBase n = *this; sub_helper(a, this->m_arg, &n.m_arg); return n; }
    inline GTpsaOrBase  dmul       (const tpsa_type    a) const
    { GTpsaOrBase n = *this; mul_helper(a, this->m_arg, &n.m_arg); return n; }
    inline GTpsaOrBase  ddiv       (const tpsa_type    a) const
    { GTpsaOrBase n = *this; div_helper(a, this->m_arg, &n.m_arg); return n; }
  ...
  template<class C>
  inline GTpsaOrBase<C> operator+
  (const typename C::base_type a, const GTpsaOrBase<C>& b){ return b.dadd(a); }
  template<class C>
  inline GTpsaOrBase<C> operator-
  (const typename C::base_type a, const GTpsaOrBase<C>& b){ return b.dsub(a); }
  template<class C>
  inline GTpsaOrBase<C> operator*
  (const typename C::base_type a, const GTpsaOrBase<C>& b){ return b.dmul(a); }
  template<class C>
  inline GTpsaOrBase<C> operator/
  (const typename C::base_type a, const GTpsaOrBase<C>& b){ return b.ddiv(a); }

  template<class C>
  inline GTpsaOrBase<C> operator+
  (const typename C::tpsa_type a, const GTpsaOrBase<C>& b){ return b.dadd(a); }
  template<class C>
  inline GTpsaOrBase<C> operator-
  (const typename C::tpsa_type a, const GTpsaOrBase<C>& b){ return b.dsub(a); }
  template<class C>
  inline GTpsaOrBase<C> operator* (const typename C::tpsa_type a, const GTpsaOrBase<C>& b){ return b.dmul(a); }
  template<class C>
  inline GTpsaOrBase<C> operator/
  (const typename C::tpsa_type a, const GTpsaOrBase<C>& b){ return b.ddiv(a); }

  /*
  template<class C>
  inline typename C::base_type operator+
  (const typename C::base_type a, const GTpsaOrBase<C>& b)
  { return a + b.cst(); }
  template<class C>
  inline typename C::base_type operator-
  (const typename C::base_type a, const GTpsaOrBase<C>& b)
  ...
  template<class C>
  inline typename C::tpsa_type operator+
  (const typename C::tpsa_type a, const GTpsaOrBase<C>& b)
  { return a + b.toTpsaType(a); }
  template<class C>
  inline typename C::tpsa_type operator-
  (const typename C::tpsa_type a, const GTpsaOrBase<C>& b)
  { return a - b.toTpsaType(a); }
  ...
  { return a * b.toTpsaType(a); }
  template<class C>
  inline typename C::tpsa_typeo operator/
  (const typename C::tpsa_type a, const GTpsaOrBase<C>& b)
  { return a / b.toTpsaType(a); }
  */
...
/*
typedef TpsaVariantTypes<std::complex<double>, gtpsa::ctpsa,
			 tpsa_typeor_double_t> TpsaVariantComplexTypes;
